  ...
  <section class="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
    <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
      <div class="mx-auto max-w-5xl">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Pagos</h2>
          ...
          <form action="#"
            ...
            <div class="mb-6 grid grid-cols-2 gap-4">
              <div class="col-span-2 sm:col-span-1">
                <label for="full_name" class="mb-2 block text-sm font-medium text-gray-900 dark:text-white"> Nombre
                  (como figura en la tarjeta)* </label>
              ...
              <div>
                <label for="card-expiration-input"
                  class="mb-2 block text-sm font-medium text-gray-900 dark:text-white">Expiración* </label>
                <div class="relative">
            ...
            <button type="submit"
              class="flex black-button w-full items-center justify-center rounded-lg bg-primary-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Paga
              ahora</button>
          </form>
          ...
          <div class="mt-6 grow sm:mt-8 lg:mt-0">
            <div
              ...
              <div class="space-y-2">
                ...
                <dl class="flex items-center justify-between gap-4">
                  <dt class="text-base font-normal text-gray-500 dark:text-gray-400">Gastos administrativos</dt>
        ...
        <p class="mt-6 text-center text-gray-500 dark:text-gray-400 sm:mt-8 lg:text-left">
          Pago procesado por <a href="#" title=""
            class="font-medium text-primary-700 underline hover:no-underline dark:text-primary-500">TecnoCreditos</a> -
          San Juan - Argentina
        </p>
      </div>
    </div>
